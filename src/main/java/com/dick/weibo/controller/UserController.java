...
import com.dick.weibo.Dao.UserMapperCustom;
import com.dick.weibo.constant.Constant;
import com.dick.weibo.po.*;
import com.dick.weibo.service.MentionService;
import com.dick.weibo.service.RelationService;
import com.dick.weibo.service.UserService;
import com.dick.weibo.service.WeiboService;
import com.dick.weibo.utils.DateConvert;
import com.dick.weibo.utils.VerifyCode;
...
public class UserController {
	...
	/*	System.out.println("-----------------");
		...
		//String testsql = userMapperCustom.loginVerify22(new UserVo());
		String testsql = userMapperCustom.testsql("111");
	...
	public String submitInfo(HttpSession session, Model model, MultipartFile user_face, UserVo userVo)
		...
		if (user_face != null && originalFilename != null && originalFilename.length() > 0) {
			...
			// 存储图片的物理路径
			String pic_path = Constant.File_PATH;
